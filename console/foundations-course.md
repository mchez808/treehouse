...
(sudo required by all apt-get commands)
...
Examples: for process ID 1234.
kill -KILL 1234
kill -TERM 1234
 
kill -STOP 1234 (akin to ctrl+z)
-
...
<I need to rewatch video to understand below>
...
ls           (list)
    ...
    ls /dir1/dir2   To demonstrate that you don't have to move your present location, in order to list files in another directory
view example:    (concatenate):  cat file1.txt file2.txt
rename example:      mv old_name.txt new_name.txt
copy a file: example:           cp old_name.txt new_name.txt
